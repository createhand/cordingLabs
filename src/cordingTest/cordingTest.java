...
//			System.out.println("aaaaa : "+ran.random(1, 1, 4, false, true));
//			System.out.println("aaaaa : "+org.apache.commons.lang3.RandomUtils.nextInt(1,5));
//			System.out.println("RandomStringUtils : "+RandomStringUtils.randomAlphanumeric(6));
//			System.out.println("aaaaa : "+System.currentTimeMillis());
//			
//			int time = 50;
//			GregorianCalendar calandar = new GregorianCalendar();
//			calandar.add(Calendar.SECOND, time);
//			System.out.println("now:"+System.currentTimeMillis());
//			System.out.println("after:"+calandar.getTimeInMillis());
//			System.out.println("after:"+DateFormatUtils.format(calandar.getTime(), "yyyyMMdd HH:mm:ss"));
			
//			SbHeros he = ((a, b) -> { return a+b;});
//			System.out.println(he.calcPlus(4, 10));
